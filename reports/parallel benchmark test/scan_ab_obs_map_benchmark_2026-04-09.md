...
bundle rooted at `parallel benchmark test/`.
...
- artifact bundle: `30` files totaling approximately `11.09 MiB`

Portable bundle contents in this directory:

- `scan_ab_obs_map_benchmark_2026-04-09.csv`: authoritative raw timing table
- `scan_ab_obs_map_benchmark_2026-04-09.png`: timing plot used by the Markdown and PDF reports
- `scan_ab_obs_map_benchmark_2026-04-09.pdf`: portable report copy
...
- generated at: `2026-04-10 08:16:53 Eastern Daylight Time`
- generated on host: `GELU-LTP`
- source CSV: `scan_ab_obs_map_benchmark_2026-04-09.csv`

Artifact roles within this bundle:

- `scan_ab_obs_map_benchmark_2026-04-09.csv` is the authoritative raw benchmark table
- `scan_ab_obs_map_benchmark_2026-04-09.md`, `scan_ab_obs_map_benchmark_2026-04-09.png`, and `scan_ab_obs_map_benchmark_2026-04-09.pdf` are derived report artifacts generated from that CSV
...
| --- | ---: | ---: | ---: | ---: | ---: |
| serial | 1 | 1 | 447.226 | 1.000 | 0 |
| process-pool | 1 | 1 | 449.688 | 0.995 | 0 |
| process-pool | 2 | 1 | 402.418 | 1.111 | 0 |
| process-pool | 3 | 1 | 388.132 | 1.152 | 0 |
| process-pool | 4 | 1 | 392.635 | 1.139 | 0 |
| process-pool | 5 | 1 | 386.832 | 1.156 | 0 |
| process-pool | 6 | 1 | 388.845 | 1.150 | 0 |
| process-pool | 7 | 1 | 390.362 | 1.146 | 0 |
| process-pool | 8 | 1 | 392.125 | 1.141 | 0 |
| process-pool | 9 | 1 | 388.756 | 1.150 | 0 |

### Plot

![Benchmark plot](scan_ab_obs_map_benchmark_2026-04-09.png)

### Interpretation

- The serial baseline in this run was the `workers=1` serial entry.
- The best process-pool result in this sweep was `workers=5` with
  `elapsed=386.832 s`, corresponding to
  `speedup=1.156x` relative to serial.
